...
async def demo_r2_with_mocks():
    ...
    with patch('umbra.storage.r2_manager.DEPS_AVAILABLE', True), \
        ...
        print("🚀 All R2 storage features are working correctly!")
        print("📊 JSONL/Parquet manifests: ✓")
        print("🔗 Presigned URLs: ✓")
        print("🔒 ETag concurrency control: ✓")
        print("📁 Module/user partitioning: ✓")
        print("🔍 Search ready (via manifests): ✓")
