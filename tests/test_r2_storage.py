...
from umbra.storage.r2_manager import ManifestEntry, R2Object, R2StorageManager
from umbra.storage.unified_storage import StorageRecord, UnifiedStorageManager
...
if __name__ == "__main__":
    ...
    async def run_basic_tests():
        ...
        entry = ManifestEntry(
            ...
            timestamp=datetime.now(UTC), data_type="jsonl", key="test.jsonl"
        )
        ...
        record = StorageRecord(
            id="test", module="test", user_id="test",
            data={}, timestamp=datetime.now(UTC), storage_backend="r2"
        )
