...
from .update_watcher import RiskLevel, UpdatePlan
...
class ClientUpdateManager:
    ...
    def __init__(self, config: UmbraConfig):
        ...
        self.logger.info("ClientUpdateManager initialized")
    ...
    async def _create_client_update_steps(self, client_info: ClientInfo,
        ...
        steps = [
            ...
            },
            {
                "id": "backup_data",
                "type": "backup_data",
                "description": "Backup client data",
            ...
            },
            {
                ...
                "description": "Start client with new image",
                "container_name": client_info.name,
            ...
            },
            {
                "id": "verify_data",
                "type": "verify_data",
                "description": "Verify client data integrity",
                "client_name": client_info.name,
                "timeout": 30
            }
        ]
