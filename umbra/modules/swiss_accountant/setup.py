...
def test_tesseract_languages():
    ...
    try:
        ...
        if missing_languages:
            ...
            print("      Install with your package manager or Tesseract installer")
            return False
        else:
...
def test_installation():
    ...
    try:
        ...
        # Import and test
        from umbra.modules.swiss_accountant import get_version, quick_start

        print("   ✅ Swiss Accountant module imported successfully")
        ...
        try:
            ...
            print("   ✅ Swiss Accountant initialized successfully")
...
def main():
    ...
    elif not test_tesseract_languages():
