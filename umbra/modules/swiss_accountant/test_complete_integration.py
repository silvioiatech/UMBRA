...
class ComprehensiveTestSuite:
    ...
    def test_module_imports(self):
        ...
        try:
            ...
            from umbra.modules.swiss_accountant.ingest import (
                DocumentParser,
                OCRProcessor,
                StatementParser,
            )
            from umbra.modules.swiss_accountant.normalize import CategoryMapper, MerchantNormalizer
...
2024-01-05;SALARY PAYMENT;3500.00;CHF"""
    ...
    def print_test_summary(self):
        ...
        if self.test_results['failed'] == 0:
            ...
            print("🚀 Ready for production use with Swiss tax compliance.")
        else:
        ...
        if self.test_results['failed'] == 0:
            ...
            print("   2. 📚 Review documentation and examples")
            print("   3. 🧾 Start processing your receipts")
            print("   4. 🏦 Import your bank statements")
            print("   5. 🧮 Calculate your tax deductions")
        else:
            print("   1. 🔍 Review failed tests and error messages")
            print("   2. 📖 Check troubleshooting guide")
            print("   3. 🔧 Fix issues and re-run tests")
            print("   4. 📝 Report persistent issues on GitHub")
