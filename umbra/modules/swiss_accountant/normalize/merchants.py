...
class MerchantNormalizer:
    ...
    def _find_exact_match(self, cleaned_name: str) -> dict[str, Any] | None:
    ...
    def _find_pattern_match(self, cleaned_name: str) -> dict[str, Any] | None:
    ...
    def _find_fuzzy_match(self, cleaned_name: str) -> dict[str, Any] | None:
    ...
    def get_merchant_info(self, merchant_id: int) -> dict[str, Any] | None:
