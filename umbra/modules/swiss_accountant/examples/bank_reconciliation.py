    ...
    try:
        ...
        for expense in sample_expenses:
            ...
            """, (
                ...
                "Sample expense for reconciliation testing"
            ))
            ...
            for i, match in enumerate(pending_matches[:3]):  # Show first 3
                ...
                if match['confidence'] > 0.8:
                    ...
                    if confirm_result['success']:
                        print("      ✅ Auto-confirmed (high confidence)")
                    else:
                        print(f"      ❌ Confirmation failed: {confirm_result.get('error')}")
                else:
                    print("      ⏸️  Pending manual review (low confidence)")

        else:
            print("   ✅ No matches need manual review!")
        ...
        if 'error' not in reconciliation_summary:
            print("   📈 Overall Reconciliation Statistics:")
        ...
        if export_result['success']:
            print("   ✅ Reconciliation export generated:")
        ...
        print("=" * 65)
        print("✅ Successfully processed multiple bank statement formats")
        print("✅ Reconciled expenses with transactions automatically")
        print("✅ Reviewed and confirmed uncertain matches")
        print("✅ Generated comprehensive reconciliation reports")
        print("✅ Exported data for audit and tax preparation")

        print("\n💡 Key Benefits Demonstrated:")
        print("   🏦 Multi-bank support (UBS, PostFinance, Revolut, etc.)")
        print("   🤖 Automated matching with high accuracy")
        print("   🎯 Configurable matching strategies and thresholds")
        print("   👤 Human oversight for uncertain matches")
        print("   📊 Detailed reporting and audit trails")
        print("   📤 Export compatibility with tax software")

        print("\n🚀 Next Steps in Real Usage:")
        print("   1. Import actual bank statement files")
        print("   2. Fine-tune matching strategies for your patterns")
        print("   3. Set up automated monthly reconciliation")
        print("   4. Review and approve pending matches")
        print("   5. Export reconciled data for tax preparation")
