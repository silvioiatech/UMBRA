...
def receipt_processing_example():
    ...
    try:
        ...
        for i, receipt_data in enumerate(sample_receipts):
            ...
            if PIL_AVAILABLE:
                ...
                if image_created:
                    ...
                    print("   ⚠️  Failed to create receipt image, using simulation")
        ...
        print("=" * 60)
        print("✅ All receipts processed and categorized")
        print("✅ Merchants normalized and stored")
        print("✅ Tax categories automatically assigned")
        print("✅ Business percentages applied")
        print("✅ Data ready for reconciliation and export")

        print("\n💡 In real usage:")
        print("   1. Place receipt images in a folder")
        print("   2. Use: sa.process_receipt(image_path)")
        print("   3. Review and adjust business percentages")
        print("   4. Reconcile with bank statements")
        print("   5. Export for tax preparation")
