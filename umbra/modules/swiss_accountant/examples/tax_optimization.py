...
def tax_optimization_example():
    ...
    try:
        ...
        if tax_result.get('success'):
            print("   ✅ Tax calculation completed for Canton Zurich")
        ...
        print("   🎯 Deduction Limits and Optimization:")
        ...
        if prof_expenses > flat_rate_limit:
            ...
            print("      💡 Keep detailed records and receipts for audit")
        else:
            print(f"      ⚠️  Flat rate deduction would be CHF {flat_rate_limit - prof_expenses:,.2f} better")
            print("      💡 Consider additional professional expenses or use flat rate")
        ...
        if pillar3a_expenses >= pillar3a_limit:
            print("      ✅ Maximum contribution achieved - optimal tax benefit")
        else:
        ...
        if childcare_expenses <= childcare_limit:
            ...
            if childcare_expenses > 0:
                print("      💡 Excellent deduction - high tax impact")
        else:
            print("      ⚠️  May exceed per-child limits")
        ...
        print("      💡 Only amounts exceeding 5% of net income are deductible")
        print("      💡 Consider timing of elective medical procedures")
        ...
        if export_result['success']:
            print("   ✅ Tax export generated successfully:")
            ...
            print("\n   📋 Export includes:")
            print("      • All deductible expenses with categories")
            print("      • Business percentage calculations")
            print("      • VAT breakdown where applicable")
            print("      • Receipt references and notes")
            print("      • Canton-specific formatting")
        ...
        print("=" * 60)
        print("✅ Comprehensive tax year analysis completed")
        print("✅ Swiss federal and cantonal rules applied")
        print("✅ Optimization opportunities identified")
        print("✅ Tax-ready export generated")
        ...
        print("\n💡 Next Steps:")
        print("   1. Implement high-priority recommendations")
        print("   2. Set up recurring pillar 3a contributions")
        print("   3. Keep detailed records for professional expenses")
        print("   4. Review and update throughout the year")
        print("   5. Consult tax advisor for complex situations")
