...
class WorkflowTester:
    ...
    async def test_run_workflow(self, workflow_json: dict[str, Any], payload: dict[str, Any] | None = None, timeout_s: int = 60) -> dict[str, Any]:
    ...
    def _extract_output_data(self, execution_data: dict[str, Any]) -> dict[str, Any] | None:
    ...
    def _calculate_performance_metrics(self, execution: TestExecution, execution_data: dict[str, Any] | None = None) -> dict[str, Any]:
