...
# Create global config instance with lazy validation for development
def _create_config():
    """Create config instance with proper error handling for development."""
    import os
    import warnings
    ...
    try:
        ...
        # In development/testing, create a config with validation skipped
        warnings.warn(f"Config validation failed: {e}. Creating development config.", UserWarning)
